...
public class Server3 extends PaxosServerNodeImpl {
	...
	public Server3(int serverId, String[] clientPort, String[] serverPort) throws IOException {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		Server3 server = new Server3(serverId, paxosNodeClientPorts, paxosNodeServerPorts);
